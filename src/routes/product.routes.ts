...
import { insertProduct, fetchAllProduct, fetchSingleProduct, deleteProduct, updateProduct, restoreProduct, getDeletedProducts } from "../controller/product.controller";
